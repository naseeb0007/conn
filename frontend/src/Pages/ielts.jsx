...
<div className="relative w-full">
        <img src={IELTSImage} alt="Doctor" className="w-full h-auto object-cover" />
      ...
      <div className="px-10 py-10">
        ...
        <div className="space-y-6">
          <div className="border-l-4 border-blue-600 pl-6">
            ...
            <p className="text-md text-gray-700 mb-3 text-justify">
            ...
            <ul className="list-disc pl-6 mb-3 text-justify ">
