  ...
  return (
    <div>
      ...
      <div className="container mx-auto my-12 p-4 space-y-9 w-full border-l-2 border-r-2 border-gray-300">
        ...
        <p className="text-lg text-gray-800 mb-4 animate__animated animate__fadeIn animate__delay-2s text-justify">
          At Covenant Education, we understand the challenges that come with learning a new language, especially Hindi. We are dedicated to providing comprehensive resources, expert guidance, and personalized attention to ensure every student reaches their fullest potential. Whether your goal is to pass the IELTS with a high band score or to learn Hindi for personal growth, we have the tools and expertise to help you achieve success.
        ...
        <ul className="list-disc ml-6 space-y-2 text-gray-700 animate__animated animate__fadeIn animate__delay-4s text-justify">
          <li>
            <strong>Expert Training:</strong> Learn from experienced instructors with a proven track record in Hindi and IELTS coaching. Our teachers are not only highly skilled but also passionate about your success, bringing years of experience to every lesson.
          </li>
          <li>
          ...
          <li>
            <strong>Comprehensive Programs:</strong> Our courses cover everything from basic to advanced levels, ensuring mastery in Hindi and IELTS. We provide a range of materials to help students at all stages of their learning journey, from beginner to expert.
          </li>
          <li>
            <strong>Proven Results:</strong> Hundreds of students have successfully achieved their goals through our structured programs. Our students consistently score high in their IELTS exams and become fluent in Hindi, opening doors to new opportunities in both personal and professional life.
          </li>
          <li>
